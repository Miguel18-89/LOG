...
storePhase2Router.get('/', authMiddleware.requireAuthorization, StorePhase2Controller.getAllPhase2s);
storePhase2Router.get('/:id', authMiddleware.requireAuthorization, StorePhase2Controller.getPhase2ById);
