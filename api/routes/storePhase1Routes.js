...
storePhase1Router.get('/', authMiddleware.requireAuthorization, StorePhase1Controller.getAllPhase1s);
storePhase1Router.get('/:id', authMiddleware.requireAuthorization, StorePhase1Controller.getPhase1ById);
